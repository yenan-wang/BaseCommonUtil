package com.ngb.wyn.common.utils.livedatabus;
 ...
 *
 * <p>
 * In addition, LiveData has {@link #onActive()} and {@link #onInactive()} methods
...
public abstract class LiveData<T> {
    ...
    public void considerNotify(ObserverWrapper observer) {
        if (!observer.mActive) {
            return;
        }
